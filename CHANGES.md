...
- `babel.stage` config is deprecated, as Babel's `stage-X` presets were removed in Babel 7 - if you provide it, nwb will warn you and enable Babel proposal plugins equivalent to the current stage they're at.
